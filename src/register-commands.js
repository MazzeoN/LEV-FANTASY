...
var testearId_1 = require("./commands/testearId");
// IDs
var CLIENT_ID = "1403029433324933214";
var GUILD_ID = "1399167008905498808";
var commands = [
    ...
    testearId_1.testearIdCommandData
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, rest.put(discord_js_1.Routes.applicationGuildCommands(CLIENT_ID, GUILD_ID), { body: commands })];
            case 1:
                _a.sent();
            ...
            case 2:
                error_1 = _a.sent();
                console.error("❌ Error registrando comandos:", error_1);
                return [3 /*break*/, 3];
